...
<html lang="en">
  <head>
    ...
    <!-- CSS files -->
    <link href="{{asset('/asset/css/tabler.min.css?1684106062')}}" rel="stylesheet"/>
    <link href="{{asset('/asset/css/tabler-flags.min.css?1684106062')}}" rel="stylesheet"/>
    <link href="{{asset('/asset/css/tabler-payments.min.css?1684106062')}}" rel="stylesheet"/>
              ...
              <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                  ...
                  <li class="list-inline-item">
                    ...
                    <a href="." class="link-secondary">fika ismatul pplg 1</a>
                    </a>
                  </li>
                </ul>
              </div>
